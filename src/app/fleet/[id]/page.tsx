      ...
      <div className="relative h-96 w-full bg-gray-100">
        ...
        <div className="absolute inset-0 flex items-end p-8">
          <div>
            ...
            <h1 className="text-4xl text-white font-cinzel font-semibold">
              {vehicle.name}
            </h1>
        ...
        <div className="max-w-4xl mx-auto py-12">
          <div className="flex flex-col lg:flex-row gap-8">
            <div className="lg:w-2/3 bg-white rounded p-6 shadow-sm">
              <h2 className="font-cinzel text-2xl text-[#0b2545] mb-4">
                Overview
              </h2>
              ...
              <h3 className="font-cinzel text-lg text-[#0b2545] mb-3">
                Features
              </h3>
              <ul className="grid grid-cols-1 sm:grid-cols-2 gap-2 mb-6">
                {vehicle.features.map((f) => (
                  <li
                    key={f}
                    className="text-neutral-700 bg-gray-50 px-3 py-2 rounded"
                  >
                    {f}
                  </li>
                ))}
              ...
              <div>
                <h3 className="font-cinzel text-lg text-[#0b2545] mb-2">
                  About this vehicle
                </h3>
            ...
            <aside className="lg:w-1/3">
              <div className="bg-white rounded p-6 shadow-sm">
                <h4 className="font-cinzel text-lg text-[#0b2545] mb-4">
                  Request Vehicle
                </h4>
                <p className="text-neutral-700 mb-4">
                  Complete a quick request and our concierge will contact you to
