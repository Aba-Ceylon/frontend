      ...
      <div className="max-w-5xl mx-auto px-6 py-12 space-y-12">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
          ...
          <div className="flex items-center gap-3 bg-white rounded p-4 shadow-sm col-span-2 sm:col-span-1">
            ...
            <div>
              ...
              <p className="text-sm text-[#1A2238] font-medium font-cinzel">{pkg.route.join(" → ")}</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex gap-4">
          <button
            ...
            className="px-6 py-3 font-cinzel text-sm rounded bg-neutral-900 text-white hover:bg-neutral-700 transition cursor-pointer"
          >
