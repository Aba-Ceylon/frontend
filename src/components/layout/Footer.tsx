  ...
  const footerLinks = [
    {
      ...
      links: [
        ...
        { label: t("footer.links.stays"), href: "/stays" },
        { label: t("footer.links.fleet"), href: "/fleet" },
        { label: t("footer.links.activities"), href: "/activities" },
      ],
    },
    {
      ...
      links: [
        ...
        { label: t("footer.links.destinations"), href: "/destinations" },
